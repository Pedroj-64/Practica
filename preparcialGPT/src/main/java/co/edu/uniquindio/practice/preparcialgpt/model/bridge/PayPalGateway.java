...
/**
 * Implementación de la pasarela de pago para PayPal
 * Implementador Concreto en el patrón Bridge
 */
public class PayPalGateway implements PasarelaPago {
    ...
    public boolean autorizar(String idTransaccion, double monto, String referencia) {
        ...
        // En una implementación real, se conectaría a la API de PayPal
        ...
        if (Math.random() < 0.05) {
            System.out.println("PayPal: Transacción rechazada para " + referencia);
            return false;
        }
        
        System.out.println("PayPal: Autorización exitosa para " + idTransaccion + " por $" + monto);
    ...
    public boolean capturar(String idTransaccion, double monto) {
        ...
        System.out.println("PayPal: Captura exitosa para " + idTransaccion + " por $" + monto);
        return true;
    }
    ...
    public boolean anular(String idTransaccion) {
        ...
        System.out.println("PayPal: Anulación exitosa para " + idTransaccion);
    ...
    public boolean reembolsar(String idTransaccion, double monto, String motivo) {
        ...
        System.out.println("PayPal: Reembolso exitoso para " + idTransaccion + 
